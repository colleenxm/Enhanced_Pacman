// NOT WRITTEN BY ME - USED TO CENTER FONT FOR PRINTING
// TAKEN FROM https://github.com/armadillu/ofxCenteredTrueTypeFont/blob/master/src/ofxCenteredTrueTypeFont.h
